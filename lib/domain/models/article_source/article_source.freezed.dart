...
class _$_ArticleSource implements _ArticleSource {
  const _$_ArticleSource({required this.name, this.id});
  ...
  @override
  String toString() {
    return 'ArticleSource(name: $name, id: $id)';
  }
...
abstract class _ArticleSource implements ArticleSource {
  const factory _ArticleSource({required final String name, final String? id}) =
      _$_ArticleSource;
